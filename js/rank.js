     ...
     $.each(data, function() {
       for(i = 1; i <= data.length; i++) {
         if(this.ranking == i && this.type == "current") {
           ...
           var movieList = '<tr class="record"><td class="ranking">'+i+'</td><td class="movie"><div class="outlines"><a href="../movieDetail/main.html" class="poster"><img src="'+this.poster+'" alt="poster" width="100%" height="100%"></a><div class="outlineMenu title"><div class="filmRating subMenu">등급</div><div class="title subMenu"><a href="../movieDetail/main.html">'+this.title+'</a></div></div><div class="outlineMenu"><div class="subMenu">평점</div><div class="rating">' + this.point.netizen + '</div><div class="subMenu">예매율</div><div class="bookRate">' + this.bookrate + '%</div></div><div class="outlineMenu"><div class="subMenu">개요</div><ul class="outline"><li class="genre">' + genres + '</li><li class="runningTime">' + this.runningtime + '</li><li class="release">개봉일 '+this.release+'</li></ul></div><div class="outlineMenu"><div class="subMenu">감독</div><div class="director">' +this.director.name+'</div></div><div class="outlineMenu"><div class="subMenu">출연</div><div class="actor">'+leadingActors+'</div></div><div class="outlineMenu media"><a href="../movieDetail/main.html">포토</a><a href="../movieDetail/main.html">관련 영상</a></div><a href="../ticket/reserve.html" class="reserveBtn">예매</a></div></td></tr>';
      ...
      for(i = 0, r = 1; i < pointnow.length; i++) {
        $.each(data, function() {
          if(pointnow[i].point == this.point.netizen && this.type == "current" && pointnow[i].title == this.title) {
            ...
            var movieList = '<tr class="record"><td class="ranking">'+r+'</td><td class="movie"><div class="outlines"><a href="../movieDetail/main.html" class="poster"><img src="'+this.poster+'" alt="poster" width="100%" height="100%"></a><div class="outlineMenu title"><div class="filmRating subMenu">등급</div><div class="title subMenu"><a href="../movieDetail/main.html">'+this.title+'</a></div></div><div class="outlineMenu"><div class="subMenu">평점</div><div class="rating">' + this.point.netizen + '</div><div class="subMenu">예매율</div><div class="bookRate">' + this.bookrate + '%</div></div><div class="outlineMenu"><div class="subMenu">개요</div><ul class="outline"><li class="genre">' + genres + '</li><li class="runningTime">' + this.runningtime + '</li><li class="release">개봉일 '+this.release+'</li></ul></div><div class="outlineMenu"><div class="subMenu">감독</div><div class="director">' +this.director.name+'</div></div><div class="outlineMenu"><div class="subMenu">출연</div><div class="actor">'+leadingActors+'</div></div><div class="outlineMenu media"><a href="../movieDetail/main.html">포토</a><a href="../movieDetail/main.html">관련 영상</a></div><a href="../ticket/reserve.html" class="reserveBtn">예매</a></div></td></tr>';
            $('.rankingTable').append(movieList);
            r++;
          }
        })
